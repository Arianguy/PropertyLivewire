<div class="w-full mx-auto px-4 sm:px-6 lg:px-8">
    <div class="flex justify-between items-center mb-6">
        <div>
            <h2 class="text-2xl font-extrabold text-gray-900 dark:text-gray-100">Create New Property</h2>
            <p class="mt-1 text-sm text-gray-600 dark:text-gray-400">Add a new property to the system</p>
        </div>
        ...
        <div class="p-4 sm:p-6 lg:p-8">
            <form wire:submit="save" class="space-y-6">
                ...
                <div class="grid grid-cols-1 lg:grid-cols-2 gap-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                            <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100">Purchase Details</h3>
                        </div>
                        <div class="p-6 grid grid-cols-1 gap-y-6 gap-x-4 sm:grid-cols-6">
                            <div class="sm:col-span-2">
                ...
                <div class="grid grid-cols-1 gap-6">
                    ...
                    <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700">
                        <div class="px-6 py-4 bg-gray-50 dark:bg-gray-700 border-b border-gray-200 dark:border-gray-600">
                            ...
                            <p class="mt-1 text-sm text-gray-500 dark:text-gray-400">Upload deeds and other property documents</p>
                        </div>
                        <div class="p-6 space-y-6">
                            ...
                            <div>
                                ...
                                <!-- Upload Deed Files -->
                                <div class="mt-2">
                                    <label for="deedFiles" class="block text-sm font-medium text-gray-700 dark:text-gray-300">Title Deed Documents (Required)</label>
                                    <div
                                        x-data="{
                                            isDropping: false,
                                            handleDrop(e) {
                                    ...
                                    @if($uploadedDeeds && count($deedFiles) > 0)
                                        <div class="mt-2">
                ...
                <div class="bg-white dark:bg-gray-800 shadow-md rounded-lg overflow-hidden border border-gray-200 dark:border-gray-700 p-6">
                    ...
                    @error('is_visible') <span class="text-red-500 text-xs mt-1">{{ $message }}</span> @enderror
                </div>
