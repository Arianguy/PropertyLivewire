        ...
        <form wire:submit="save" class="p-4 sm:p-6 lg:p-8">
            <div class="grid grid-cols-1 gap-6 sm:grid-cols-2">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" wire:model="name" id="name" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6" placeholder="Enter tenant name">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="email" wire:model="email" id="email" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6" placeholder="Enter email address">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" wire:model="mobile" id="mobile" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6" placeholder="Enter mobile number (10-15 digits)" minlength="10" maxlength="15">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <select wire:model="nationality" id="nationality" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6">
                ...
                <div>
                    <label for="eid" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-100">Emirates ID</label>
                    <div class="mt-2">
                        <input type="text" wire:model.live="eid" id="eid" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6" placeholder="Enter Emirates ID (15 digits)">
                        ...
                        @error('eid') <span class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                    </div>
                </div>

                <div>
                    <label for="eidexp" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-100">Emirates ID Expiry Date</label>
                    <div class="mt-2">
                        <input type="date" wire:model="eidexp" id="eidexp" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6">
                        @error('eidexp') <span class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="text" wire:model="passport_no" id="passport_no" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6" placeholder="Enter passport number">
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="date" wire:model="passport_expiry" id="passport_expiry" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6">
                ...
                <div>
                    <label for="visa" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-100">Visa of Company</label>
                    <div class="mt-2">
                        <input type="text" wire:model="visa" id="visa" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6" placeholder="Enter visa company information" minlength="5" maxlength="95">
                        @error('visa') <span class="mt-2 text-sm text-red-600 dark:text-red-400">{{ $message }}</span> @enderror
                    </div>
                </div>
                ...
                <div>
                    ...
                    <div class="mt-2">
                        <input type="date" wire:model="visa_expiry" id="visa_expiry" class="block w-full rounded-md border-0 py-3 pl-4 text-gray-900 dark:text-gray-100 shadow-sm ring-1 ring-inset ring-gray-300 dark:ring-gray-700 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-primary-600 dark:bg-gray-800 sm:text-base sm:leading-6">
                ...
                <!-- Document Upload -->
                <div class="sm:col-span-2">
                    <h3 class="text-lg font-medium text-gray-900 dark:text-gray-100 mb-4 mt-2 pb-2 border-b border-gray-200 dark:border-gray-700">Document Upload</h3>
                </div>
