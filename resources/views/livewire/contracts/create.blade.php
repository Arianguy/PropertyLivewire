<div class="mx-auto max-w-7xl">
    <div class="flex items-center justify-between">
        <div>
            <h2 class="text-lg font-medium text-gray-900 dark:text-gray-100">Create Contract</h2>
    ...
    <form wire:submit="save" class="mt-6 space-y-8 divide-y divide-gray-200 dark:divide-gray-700">
        <div class="space-y-8">
            <div class="grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-2">
                <!-- Contract Number -->
                <div>
                    <label for="name" class="block text-sm font-medium leading-6 text-gray-900 dark:text-gray-100">Contract Number</label>
                    <div class="mt-2">
                ...
                <div>
                    ...
                    <div class="mt-2 space-y-2">
                        <div class="flex items-center">
                            <input id="ejari-yes" wire:model="ejari" type="radio" value="YES" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600 dark:border-gray-700">
                            <label for="ejari-yes" class="ml-2 block text-sm text-gray-900 dark:text-gray-100">Yes</label>
                        </div>
                        <div class="flex items-center">
                            <input id="ejari-no" wire:model="ejari" type="radio" value="NO" class="h-4 w-4 border-gray-300 text-indigo-600 focus:ring-indigo-600 dark:border-gray-700">
                            <label for="ejari-no" class="ml-2 block text-sm text-gray-900 dark:text-gray-100">No</label>
                        </div>
                    </div>
