...
#[Title('Contract Receipts Details')] // Changed title slightly for clarity
class ShowAllForContract extends Component // Renamed class
{
    use WithPagination;
    ...
    public function render()
    {
        ...
        return view('livewire.receipts.show-all-for-contract', [
